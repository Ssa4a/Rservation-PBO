...
public class MahasiswaDosen extends UserBase {
    ...
    public MahasiswaDosen() {
        super("default_username", "default_email@example.com", "default_password", Role.MAHASISWA.name());  // Memanggil konstruktor superclass UserBase dengan nilai default
    }
    ...
    public MahasiswaDosen(String username, String email, String password) {
        super(username, email, password, Role.MAHASISWA.name());  // Memanggil konstruktor superclass UserBase dengan Role enum
    }
